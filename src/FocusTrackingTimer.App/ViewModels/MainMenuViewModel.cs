...
{
    private static readonly Brush SelectedTabBackground = ThemeBrushes.LightSurface;
    private static readonly Brush SelectedTabForeground = ThemeBrushes.PrimaryText;
